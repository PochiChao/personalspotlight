...
import logoHouseofSeason from '@/images/logos/houseofseason.png'
...
const projects = [
  ...
  },
  {
    name: 'Recce',
    description:
      "Uses OpenAI's GPT-3.5-turbo to recommend media (e.g. books, TV shows) based on a base reference and optional search refinement. Used Prisma with MongoDB, TailwindCSS, TypeScript, Next.js, React.",
    link: {
